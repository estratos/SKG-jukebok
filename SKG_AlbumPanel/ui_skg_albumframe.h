...
public:
    ...
    void setupUi(QFrame *SKG_AlbumFrame)
    {
        ...
        sizePolicy2.setHeightForWidth(listTracks->sizePolicy().hasHeightForWidth());
        listTracks->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setVerticalStretch(18);
        sizePolicy3.setHeightForWidth(lblAlbumName->sizePolicy().hasHeightForWidth());
        lblAlbumName->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(lblArtistName->sizePolicy().hasHeightForWidth());
        lblArtistName->setSizePolicy(sizePolicy3);
        QFont font1;
